...
// korean point average : 문법 오류. 이름은 띄어쓰기 지원하지 않는다.
// 2. 파스칼 표기 기법
...
fun main() {
    ...
    // 변수에 값을 저장한다.
    // 변수에는 값 하나만 저장할 수 있다.
    // 값을 다시 저정하면 기존의 저장된 값을 삭제되어 덮어씌워 진다.
    // = : 대입연산자. 우측의 값을 좌측의 변수에 저장한다.
    a1 = 100
    // 변수의 이름만 작성하면 변수의 저장되어 있는 값을 가져와 사용할 수 있다.
    println("a1 : " + a1)
    ...
    // 문자열 결합
    // 문자열 + 문자열 : 문자열 들을 합친 새로운 문자열이 만들어진다.
    var a20 = "안녕하세요" + "반갑습니다"
    println("a20 : " + a20)
