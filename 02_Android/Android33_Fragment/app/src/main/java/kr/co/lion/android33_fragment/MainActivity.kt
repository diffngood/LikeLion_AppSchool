...
class MainActivity : AppCompatActivity() {
    ...
    fun replaceFragment(name:FragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        if (newFragment != null){
            ...
            // Fragment 를 교체한다. (이전 Fragment가 없으면 새롭게 추가하는 역할을 수행한다)
            // 첫 번쨰 매개 변수 : Fragment를 배치할 FragmentContainerView의 ID
            // 두 번째 매개 변수 : 보여주고하는 Fragment 객체들
