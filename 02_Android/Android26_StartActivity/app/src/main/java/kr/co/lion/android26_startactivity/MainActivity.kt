...
class MainActivity : AppCompatActivity() {
    ...
    // startActivityForResult 메스드를 통해 다른 Activity 를 실행하고
                    ...
                    RESULT_OK -> {
                        activityMainBinding.apply {
                            ...
                            if (data != null){
                                ...
                                textViewMain.append("value1 : ${value1}\n")
                                textViewMain.append("value1 : ${value2}\n")
                                textViewMain.append("value1 : ${value3}\n")
                            }
                        }
                    }
