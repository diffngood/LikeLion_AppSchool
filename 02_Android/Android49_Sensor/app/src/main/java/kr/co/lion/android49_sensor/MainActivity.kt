...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityMainBinding.apply {
            ...
            } // button4(자이로 스코프 센서) Listener (end)
            ...
            } // button6(마그네틱 필드 센서) Listener (end)
        }
    }
    ...
    inner class MagneticSensorListener : SensorEventListener {
        ...
        override fun onSensorChanged(event: SensorEvent?) {
            if (event != null) {
                ...
                activityMainBinding.textView.text = "X 축 주변 자기장 : $a1"
                activityMainBinding.textView2.text = "Y 축 주변 자기장 : $a2"
                activityMainBinding.textView3.text = "Z 축 주변 자기장 : $a3"
            }
        }
