...
// 2. build.gradle.kts 파일에 다음과 같이 작성하고 sync now를 눌러둔다.
// buildFeatures{
//      viewBinding = true
// }
...
//        })
        ...
        // activity_main.xml 을 관리하는 Viewbinding 을 통해 UI 요소들의 객체를 생성한다.
        ...
        // Viewbinding이 관리하는 View 들 중 최상위 View를 설정하여 화면에 보여준다
        // ViewBinding이 가지고 있는 root 프로퍼티는 가장 최상위에는 View를 지칭한다.
        // 지칭한 View를 화면에 보여준다. (대부분 최상위의 Layout이다.)
