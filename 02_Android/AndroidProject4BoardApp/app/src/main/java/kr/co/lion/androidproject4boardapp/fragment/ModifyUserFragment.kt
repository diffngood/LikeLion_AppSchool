...
class ModifyUserFragment : Fragment() {
    ...
    fun updateUserData(){
        ...
        // 객체에 담는다.
        val userModel = UserModel(contentActivity.loginUserIdx, "", userPw, userNickName, userAge, userGender, userHobby1,
            userHobby2, userHobby3, userHobby4, userHobby5, userHobby6, 0)
