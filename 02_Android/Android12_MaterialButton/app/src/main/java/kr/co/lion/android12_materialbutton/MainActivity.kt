...
// Material 3 라이브러리를 적용해주면 그냥 Button을 사용해도 Material Button 처럼 사용할 수 있다.
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityMainBinding.apply {
            ...
            // MaterialButtonToggleGroup의 버튼을 처음부터 선택해준다.
            ...
            toggleGroup2.check(R.id.toggleButton4) // 적용되고 싱글셀렉션이라 해지되고 아래의 버튼 5번째가 설정됨
            ...
            toggleGroup2.addOnButtonCheckedListener { group, checkedId, isChecked ->
                ...
                when(checkedId){
                    R.id.toggleButton4 -> {
                        if (isChecked){
                            textView.text = "토글 버튼 4가 체크되었습니다"
                        }
                    }
                    R.id.toggleButton5 -> {
                        if (isChecked){
                            textView.text = "토글 버튼 5가 체크되었습니다"
                        }
                    }
                    R.id.toggleButton6 -> {
                        if (isChecked){
            ...
            buttonResult.setOnClickListener {
                ...
                toggleGroup1.checkedButtonIds.forEach {
                    when(it){
                        ...
                        R.id.toggleButton2 -> textView.append("토글2이 체크되어 있습니다\n")
                        R.id.toggleButton3 -> textView.append("토글3이 체크되어 있습니다\n")
                    }
                }// toggleGroup1 forEach(end)
                ...
                when(toggleGroup2.checkedButtonId){
                    ...
                    R.id.toggleButton6 -> textView.append("토글6가 체크 되어 있습니다")
                }
            }
